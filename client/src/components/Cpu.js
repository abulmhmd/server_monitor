          ...
          <div className="cpu_data">
            ...
            <div className="cpu_data_info">
              <div className="cpu_data_cpus">
                <span className="cpu_data_label">CPU core</span>
                <span className="cpu_data_data"> {props.cpuData.numCpus}</span>
              </div>
              <div className="cpu_data_cpus">
                <span className="cpu_data_label">CPU Speed</span>
                <span className="cpu_data_data"> {props.cpuData.cpuSpeed} MHz</span>
              </div>
              <div className="cpu_data_cpus">
                <span className="cpu_data_label">Architecture</span>
                <span className="cpu_data_data"> {props.cpuData.Arch}</span>
              </div>
            </div>
          </div>
        </div>
